...
# This script runs fast, so we can use it for the entire database
# Load the IVN data
...
# Filter pairs with similarity scores above 0.3
similarity_df = similarity_df[similarity_df['Similarity Score'] > 0.2]
...
output_df.to_csv('ivn_similarity_scores_complete_above_0_2.csv', index=False)
print("Done!")
